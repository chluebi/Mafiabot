...
class Duel(commands.Cog):
    ...
    "{} threw an urumawashi geri (Karate hook kick) at {}!": "https://i.pinimg.com/originals/38/fe/ad/38feadf424592d823514d24b2313cada.gif",
    ...
    "{} punched {} through the wall!": "https://66.media.tumblr.com/0b595d67b9ecd1f56832c0d9cc84c3f0/tumblr_p2968hqraP1rmrpdmo4_400.gif",
    ...
    blocks = {"{} blocked all of {}'s attacks with elbows!": "https://66.media.tumblr.com/6e29fc2555517475c055300480e56922/tumblr_p1643yvSA81rmrpdmo1_400.gif",
    ...
    async def playDuel(self, player1, player2, channel):
        ...
        while p1Health !=0 and p2Health!=0:
            ...
            if p1GetsTurn == None:
                ...
                embed.set_image(url = "https://thumbs.gfycat.com/PassionateRectangularBrahmancow-small.gif")
        ...
        if p1Health == 0:
            randPoints = random.randint(1, 11)
